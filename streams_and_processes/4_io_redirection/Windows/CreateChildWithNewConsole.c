/*
    ...
    default stdin, stdout, stderr streams).

    Run this program with a command line like this
      C:\>CreateChildWithNewConsole.exe < double.c > result.txt
    and you will see that the child ignores the I/O redirection
    (since the child does not inherit it's parent's I/O streams).

...
/**
   ...
   and prints to its standard output the hexadecimal string
...
<p>
   See:
   <ul>
   <li><a href="https://en.wikipedia.org/wiki/Hex_dump">https://en.wikipedia.org/wiki/Hex_dump</a></li>
   <li><a href="https://en.wikipedia.org/wiki/Hexadecimal">https://en.wikipedia.org/wiki/Hexadecimal</a></li>
   <li><a href="https://en.wikipedia.org/wiki/Binary_file">https://en.wikipedia.org/wiki/Binary_file</a></li>
   </ul>
   @see BinaryDump
   @see DecimalDump
*/
